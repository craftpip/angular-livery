...
export class BarGraphComponent implements AfterViewInit {
    ...
    async _query(resolve, reject) {
        ...
        let legendColumn = this.card.options.viewOptions.bar.legend;
        let groupByColumn = this.card.options.viewOptions.bar.groupBy;
        let lines = this.card.options.viewOptions.bar.lines;
