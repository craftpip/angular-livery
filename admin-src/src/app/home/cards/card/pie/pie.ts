...
export class PieGraphComponent implements AfterViewInit {
    ...
    query(): Promise<DashboardCard> {
        ...
        return new Promise((resolve, reject) => {
            let legendColumn = this.card.options.viewOptions.pie.legend;
            let valueColumn = this.card.options.viewOptions.pie.value;
            let valueAggregator = this.card.options.viewOptions.pie.valueAggregator.toUpperCase();
