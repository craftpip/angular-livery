...
return [
    ...
    // check for a contact agent match after loading the cookie (optional, default = true)
    'match_ua'               => true,
    ...
    /**
     * If the Session ID changes the user will be logged out,
     * because his session is validated depending on the session id.
     * That is the reason to disable session id rotation.
     */
    'rotation_time'          => false,
    ...
    'db'                     => [
        ...
        'database'       => null,
        // name of the database name (as configured in config/db.php)
        'table'          => 'sessions',
